...
import music.model.MusicNote;
import music.model.Note;
import music.view.CompositeViewImpl;
import music.view.GuiView;
import music.view.GuiViewFrame;
...
/**
 * Controller for the view of the editor
 */
public class MusicController {
  ...
  /**
   * Gets the current beat of composition
   *
   * @return currentBeat
   */
